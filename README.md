...
| Dossier | Rôle |
|---|---|
| `kernel/contracts/` | Foundation Kernel — contrats A1–A9 et primitives partagées (E0 ; A8 depuis E4 ; A9 depuis E6) |
...
npm run foundation:test        # contrats A1–A9, compiler, CLI, golden Asteria
