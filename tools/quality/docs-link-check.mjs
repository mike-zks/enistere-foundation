...
// The whole repository. Archived documents describe removed code on purpose
// (docs/archive, ADR-094): their links are history, not navigation.
const DEFAULT_TARGETS = ['.'];
const SKIPPED_DIRECTORIES = new Set(['node_modules', '.git', 'archive']);
