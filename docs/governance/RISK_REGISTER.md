...
| R-16 | Écart entre le dossier (documents 03 §6.11, 06 §4.6, §4.7, §6.8 E1/E3/E10, R0) et les décisions de repartir propre et de redéfinir E1. | High | Medium | Medium | Document 06 révisé en v1.1 (modifications suivies à accepter) ; document 03 §6.11 restant ; ADR-094/095 prévalent d'ici là. | Gouvernance | Ouvert |
