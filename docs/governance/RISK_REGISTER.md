...
| R-15 | **Checks requis obsolètes** : le ruleset `protect-main` exige encore les huit checks de l'ancienne CI, qui ne s'exécutent plus. Aucune PR ne peut être mergée. | High | High | High | Action humaine : remplacer par `kernel`, `secret-scan`, `docs`, `audit` (ADR-094). | Responsable | Ouvert |
| R-16 | Écart entre le dossier (documents 03 §6.11, 06 §4.6, §4.7, E1, E10, R0) et la décision de repartir propre. | High | Medium | Medium | ADR-094 prévaut par décision explicite ; mise à jour humaine des `.docx` demandée. | Gouvernance | Ouvert |
