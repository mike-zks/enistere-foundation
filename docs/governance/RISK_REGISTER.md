...
| R-16 | Écart entre le dossier (documents 03 §6.11, 06 §4.6, §4.7, §6.8 E1/E3/E10, R0) et les décisions de repartir propre et de redéfinir E1. | High | Medium | Medium | ADR-094 et ADR-095 prévalent par décision explicite ; mise à jour humaine des `.docx` demandée. | Gouvernance | Ouvert |
